...
static char blktrace_version[] = "2.0.1";
...
#define S_OPTS	"d:a:A:r:o:kw:vVb:n:D:lh:pP:sI:"
...
static int handle_args(int argc, char *argv[])
{
	...
	while ((c = getopt_long(argc, argv, S_OPTS, l_opts, NULL)) >= 0) {
		...
		case 'P':
			...
			fprintf(stderr, "Set pid_filter to %i", pid_filter);
			break;
		default:
			show_usage(argv[0]);
			exit(1);
